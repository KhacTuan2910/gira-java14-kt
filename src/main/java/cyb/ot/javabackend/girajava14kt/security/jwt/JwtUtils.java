package cyb.ot.javabackend.girajava14kt.security.jwt;
...
public class JwtUtils {
	...
	public String genarateJwtFakeToken(String username) {
		Date now = new Date();
	...
	public boolean validateJwtToken(String token) {
		try {
			...
			log.error("Invalid Token: {}", e3.getLocalizedMessage());
		} catch (IllegalArgumentException e4) {
			log.error("JWT claims string is empty: {}", e4.getLocalizedMessage());
